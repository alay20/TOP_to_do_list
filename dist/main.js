...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   createFilteredTasks: () => (/* binding */ createFilteredTasks)\n/* harmony export */ });\n/* harmony import */ var _icons_checkbox_blank_outline_svg__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./icons/checkbox-blank-outline.svg */ \"./src/icons/checkbox-blank-outline.svg\");\n/* harmony import */ var _icons_star_svg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./icons/star.svg */ \"./src/icons/star.svg\");\n/* harmony import */ var _icons_dots_vertical_svg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./icons/dots-vertical.svg */ \"./src/icons/dots-vertical.svg\");\n/* harmony import */ var _filterTasksLastClickedProject__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./filterTasksLastClickedProject */ \"./src/filterTasksLastClickedProject.js\");\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils */ \"./src/utils.js\");\n\n\n\n\n\n\nconst createFilteredTasks = () => {\n\n        _utils__WEBPACK_IMPORTED_MODULE_4__.taskList.replaceChildren();\n        _utils__WEBPACK_IMPORTED_MODULE_4__.taskList.remove();\n\n        const tasksFilteredClickedProjectObj = (0,_filterTasksLastClickedProject__WEBPACK_IMPORTED_MODULE_3__.filterTasksLastClickedProject)();\n\n        Object.entries(tasksFilteredClickedProjectObj).forEach(([key, getFunction]) => {\n        \n                // getTaskTitle, getTaskDescription, getTaskDueDate, getProject\n                \n                const newTaskLi = document.createElement('li');\n                // taskList.dataset.projectTitle = lastClickedProject;\n\n\n                const taskCheckbox = new Image();\n                taskCheckbox.src = _icons_checkbox_blank_outline_svg__WEBPACK_IMPORTED_MODULE_0__;\n                taskCheckbox.classList.add('icons');\n                taskCheckbox.classList.add('task-checkbox');\n\n                const taskText = document.createElement('p');\n                taskText.classList.add('task-text');\n                taskText.textContent = getFunction.getTaskTitle().split('_')[0];  \n                console.log(\"Task Title:\", getFunction.getTaskTitle().split('_')[0]);\n\n                const taskDueDateDiv = document.createElement('div');\n\n                //Determine text output for due date element\n                if (getFunction.getTaskDueDate() === '') {\n                        taskDueDateDiv.textContent = 'No Due Date'\n                } else {\n                        taskDueDateDiv.textContent = getTaskDueDate();\n                }\n\n\n                const starImportant = new Image();\n                starImportant.src = _icons_star_svg__WEBPACK_IMPORTED_MODULE_1__;\n                starImportant.classList.add('icons');\n\n                const taskMenuIcon = new Image();\n                taskMenuIcon.src = _icons_dots_vertical_svg__WEBPACK_IMPORTED_MODULE_2__;\n                taskMenuIcon.classList.add('icons');\n\n                newTaskLi.append(taskCheckbox, taskText, taskDueDateDiv, starImportant, taskMenuIcon);\n                _utils__WEBPACK_IMPORTED_MODULE_4__.taskList.appendChild(newTaskLi);\n\n        });\n        \n\n        if (Object.entries(tasksFilteredClickedProjectObj).length > 0) {\n                _utils__WEBPACK_IMPORTED_MODULE_4__.openAddTaskBtnCont.insertAdjacentElement('beforebegin', _utils__WEBPACK_IMPORTED_MODULE_4__.taskList)\n        }; \n\n};\n\n\n\n\n//# sourceURL=webpack://top_to_do_list/./src/displayClickedProjectTasks.js?");
