...
export const displayNextSevenTasks = (e) => {
    if (e.target.closest('.task-filter.next7days-tasks')) {

        taskList.replaceChildren();
        rightContainer.replaceChildren();

        projectTitleCont.textContent = "Next 7 Days";
        ...
        Object.entries(allTasks).forEach(([task, method]) => {
            ...
            if ( isWithinInterval(dateToFormat, {start: today, end: sevenDaysFromToday} )) {
